    ...
    return (
      <div style={myStyle}>
        ...
        <Card
          text={"light"}
          // style={{ width: "90%" }}
          className=" text-white my-md-5 mx-md-5 "
        >
          <Card.Img
            src="https://as2.ftcdn.net/v2/jpg/01/32/53/25/1000_F_132532507_hRJeD5R3yOimMtg1VThRf169vXNzNzBv.jpg"
            height="300"
            alt="Card image"
          />
          <Card.ImgOverlay>
        ...
        >
          <frontContainer>
            ...
            >
              <Card.Img
                src="https://as2.ftcdn.net/v2/jpg/04/95/31/45/1000_F_495314554_hd9PYF44LEOMqAs5SlJblz9AoHrPmyHQ.jpg"
                alt="Card image"
                height="300"
              />
              <Card.ImgOverlay>
